...
- **VA** (issues [#1377](https://github.com/openstates/issues/issues/1377)/[#1385](https://github.com/openstates/issues/issues/1385)) — both technically fixed upstream, neither closed. Worth a manual close.
