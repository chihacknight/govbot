...
- Toolkit repo: [chihacknight/govbot](https://github.com/chihacknight/govbot)
...
[DATA_STRUCTURES.md](https://github.com/chihacknight/govbot/blob/main/actions/format/docs/DATA_STRUCTURES.md)
...
[README_TEMPLATE.md](https://github.com/chihacknight/govbot/blob/main/actions/format/docs/for-caller-repos/README_TEMPLATE.md)

To manage multiple pipelines or locales, see our [pipeline manager documentation](https://github.com/chihacknight/govbot/tree/main/actions/pipeline-manager)
